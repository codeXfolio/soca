    ...
    <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm">
      <Card className="mx-auto max-w-md relative">
        <Button
          ...
          onClick={() => document.dispatchEvent(new CustomEvent("dismissAssistantTooltip"))}
        >
          <X className="h-4 w-4" />
        ...
        <CardHeader className="text-center">
          ...
          <CardDescription>I can help you navigate the Web3 ecosystem safely and efficiently</CardDescription>
        </CardHeader>
        <CardContent>
