   ...
   return (
      <Card
         className={`overflow-hidden transition-all hover:shadow-md ${
            airdrop.status === "incoming" ? "border-dashed" : ""
         }`}
      >
               ...
               <div className="flex items-center gap-3">
                  ...
                  <div>
                     ...
                     <div className="mt-1 flex items-center gap-2">
                        <Badge
                           variant="outline"
                           className={getDifficultyColor(airdrop.difficulty)}
                        >
                           {airdrop.difficulty.charAt(0).toUpperCase() +
                              airdrop.difficulty.slice(1)}
                        </Badge>
                     </div>
                  </div>
               </div>
            ...
            <Dialog>
               <DialogTrigger asChild>
                  <Button
                     size="sm"
                     variant={
                        airdrop.status === "active" ? "default" : "outline"
                     }
                  >
                     {airdrop.status === "active" ? (
                        <>
